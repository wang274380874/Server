...
//位置信息
	...
	DeferWindowPos(hDwp,m_btSuperRobBanker, NULL, 13, 335, 0, 0, uFlags|SWP_NOSIZE);
...
VOID CGameClientView::DrawGameView(CDC * pDC, INT nWidth, INT nHeight)
{
	...
	{
		m_ImageSuperRobBanker.DrawImage( pDC, 180, 208);
	}

	//超级抢庄庄家框架
	if (m_wBankerUser != INVALID_CHAIR && m_typeCurrentBanker == SUPERROB_BANKER)
	{
		m_ImageSuperRobBankerUserFrame.DrawImage( pDC, 176, 48);
	}
