...
class TableFrameSink : public ITableFrameSink, public ITableUserAction {
 ...
 private:
  ...
  //int m_nDist1; // 第一个分发奖金的玩家
  //int m_nDist2; // 第二个分发奖金的玩家
  //int m_nDist3; // 第二个分发奖金的玩家
  //int m_nDist4; // 第二个分发奖金的玩家
  //int m_nDistTimes;

  /*
  void DistributePlanA();
  void DistributePlanB();
  void DistributePlanC();
  */
  //void DistributePlanD();
  short m_sCurrentRevenue;
  ///////////////////////////////////////////////////////////////////////////////////
};
