...
bool SoundSetting::Initialize() {
  ...
  sound_setting_->SetBackgroundImage("lkpy6\\images\\gui\\setDlg.fish");
  ...
  back_music_->SetSelectedImage("lkpy6\\images\\gui\\setDlgCheck1.fish");
  back_music_->setPosition(38, 106);
  back_music_->setSelected(true);
  sound_setting_->add(back_music_);

  game_sound_ = new fish::CheckBox();
  game_sound_->SetSelectedImage("lkpy6\\images\\gui\\setDlgCheck1.fish");
  ...
  back_music_slider_->SetSliderImage("lkpy6\\images\\gui\\setDlgSlider.fish", "lkpy6\\images\\gui\\SetDlgPitch.fish", "lkpy6\\images\\gui\\setDlgThumb.fish");
  ...
  game_sound_slider_->SetSliderImage("lkpy6\\images\\gui\\setDlgSlider.fish", "lkpy6\\images\\gui\\SetDlgPitch.fish", "lkpy6\\images\\gui\\setDlgThumb.fish");
