...
public:
	...
	//私人房间
public:
	virtual void SetPersonalGameRule() { return; };
...
private:
 ...
 private:
	 ...
	 bool OnSubUserFire(IServerUserItem* server_user_item, int bullet_id, BulletKind bullet_kind, float angle, int bullet_mul, int lock_fishid, float fire_speed,bool bBadManCheat = false);
