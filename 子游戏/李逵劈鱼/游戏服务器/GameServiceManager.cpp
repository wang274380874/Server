...
CGameServiceManager::CGameServiceManager()
{
	...
	m_GameServiceAttrib.wSupporType = GAME_GENRE_GOLD | GAME_GENRE_EDUCATE|GAME_GENRE_PERSONAL;
	...
	lstrcpyn(m_GameServiceAttrib.szServerDLLName, TEXT("xlkpy_server.DLL"), CountArray(m_GameServiceAttrib.szServerDLLName));
