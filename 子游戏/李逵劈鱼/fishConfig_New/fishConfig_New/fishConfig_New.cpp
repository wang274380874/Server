...
// fishConfig_New.cpp : 定义应用程序的类行为。
//

#include "stdafx.h"
#include "fishConfig_New.h"
#include "fishConfig_NewDlg.h"
#include <thread>
#ifdef _DEBUG
...
BEGIN_MESSAGE_MAP(CfishConfig_NewApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CfishConfig_NewApp 构造

CfishConfig_NewApp::CfishConfig_NewApp()
{
	// 支持重新启动管理器
...
// 唯一的一个 CfishConfig_NewApp 对象

CfishConfig_NewApp theApp;


// CfishConfig_NewApp 初始化

BOOL CfishConfig_NewApp::InitInstance()
{
	if (!PipeLoading())
	{
		return false;
...
// 绑定进程
 bool CfishConfig_NewApp::PipeLoading()
 {
...
// 
// /发送数据
// bool CfishConfig_NewApp::PipeSendData(WORD wSubCmdID, VOID * pData, WORD wDataSize)
// {
...
// 	return true;
// }
// bool CfishConfig_NewApp::pipeSendDataTren(VOID * pData, WORD wDataSize)
// {
// 
// 	if (m_hServerPipe == INVALID_HANDLE_VALUE) return false;
...
// }
// 
// bool CfishConfig_NewApp::PipeMsgEvent(WORD wSubCmdID, VOID * pData, WORD wDataSize)
// {
// 	///效验接口
// 	//ASSERT(m_hClientPipe != INVALID_HANDLE_VALUE);
// 	if (m_hClientPipe == INVALID_HANDLE_VALUE) return false;
// 	CfishConfig_NewDlg* pDlg = dynamic_cast<CfishConfig_NewDlg*>(m_pMainWnd);
// 	return true;  //edit by yang yang 二〇一八年八月九日 09:44:17
