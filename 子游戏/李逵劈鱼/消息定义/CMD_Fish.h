...
#define KIND_ID               510  //301
#define GAME_NAME             TEXT("李逵")
...
#endif
const float kChairDefaultAngle[GAME_PLAYER] = { M_PI, M_PI, M_PI, -M_PI_2, 0, 0,  };
...
struct CMD_C_UserFire {
  ...
  BYTE cmd_version; //版本号
  float angle;	// 子弹角度
  int bullet_mulriple; //子弹倍率 1000~1万
