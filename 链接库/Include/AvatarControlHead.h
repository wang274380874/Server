...
//金币头像
struct tagGoldAvatarItem
{
  BYTE              cbAvatarIndex;            //头像索引
  SCORE             lCriticalGold;            //临界金币
};
typedef CWHArray<tagGoldAvatarItem *> CGoldAvatarArray;         //金币头像数组
//////////////////////////////////////////////////////////////////////////////////
...
public:
  ...
  //获取资源
  virtual VOID GetScoreAvatarResource(tagAvatarResource & AvatarResource)=NULL;
  //绘画框架
...
public:
  //获取索引
  virtual VOID GetScoreFaceIndex(BYTE cbGender, bool bOffline, SCORE lScore, INT &nXIndex, INT &nYIndex)=NULL;
  //绘画头像
  virtual VOID DrawGenderFaceNormal(CDC * pDC, INT nXPos, INT nYPos, INT nWidth, INT nHeight, BYTE cbGender)=NULL;
  //绘画头像
  virtual VOID DrawGenderFaceOffline(CDC * pDC, INT nXPos, INT nYPos, INT nWidth, INT nHeight, BYTE cbGender)=NULL;
  //绘画头像
  virtual VOID DrawScoreFaceNormal(CDC * pDC, INT nXPos, INT nYPos, BYTE cbGender, SCORE lScore)=NULL;
  //绘画头像
  virtual VOID DrawScoreFaceOffline(CDC * pDC, INT nXPos, INT nYPos, BYTE cbGender, SCORE lScore)=NULL;
};
