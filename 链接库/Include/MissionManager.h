...
public:
  ...
  //当前连接
  LPCTSTR GetCurrentServer()
  {
    return m_szCurrentServer;
  }
...
public:
  ...
  //设置接口
  VOID SetMissionSocketSink(IMissionSocketSink * pIMissionSocketSink)
  {
    m_pIMissionSocketSink=pIMissionSocketSink;
  }
...
public:
  ...
  //任务管理
  CMissionManager * GetMissionManager()
  {
...
public:
  ...
  LPCTSTR GetCurrentServer()
  {
    return m_MissionSocket.GetCurrentServer();
  }
