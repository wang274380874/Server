...
public:
  //获取颜色
  tagSkinRenderInfo GetSkinRenderInfo()
  {
    return m_SkinRenderInfo;
  }
  //设置颜色
  VOID SetSkinRenderInfo(const tagSkinRenderInfo & SkinRenderInfo)
  {
    m_SkinRenderInfo=SkinRenderInfo;
  }

  //静态函数
public:
  //获取实例
  static CSkinRenderManager * GetInstance()
  {
    return m_pSkinRenderManager;
  }
};
