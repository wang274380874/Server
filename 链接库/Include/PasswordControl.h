...
//密码键盘
class SHARE_CONTROL_CLASS CPasswordKeyboardEx : public CDialog
{
  //窗口变量
protected:
  HWND              m_hBuddyWnd;            //伙伴窗口
  CEditUI *           m_pEditUI;              //伙伴控件
...
public:
  //设置伙伴
  VOID SetBuddyInfo(HWND hBuddyWnd, CEditUI *pEditUI);
  //设置背景色
