...
public:
  ...
  WORD GetSelectFace()
  {
    return m_wSelectFace;
  }
  //设置接口
  VOID SetFaceItemSelectEvent(IFaceItemSelectEvent * pIFaceItemSelectEvent)
  {
    m_pIFaceItemSelectEvent=pIFaceItemSelectEvent;
  }
...
public:
  //选择数目
  virtual VOID SetAllowItemFull()
  {
    m_FaceItemSelectWnd.SetAllowItemFull();
  }
  //选择数目
  virtual VOID SetAllowItemCount(WORD wFaceCount)
  {
    m_FaceItemSelectWnd.SetAllowItemCount(wFaceCount);
  }
