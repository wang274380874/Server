...
public:
  ...
  //材质控制
  VOID  SetUseMeshMaterials(bool bFlag)
  {
  ...
  //嵌套模型
  VOID  SetNestedModel(CD3DStaticModel * pNestedModel)
  {
    m_pNestedModel = pNestedModel;
  }
  //嵌套矩阵
  VOID  SetNestedMatrix(D3DXMATRIX * pNestedMatrix)
  {
    m_pNestedMatrix = pNestedMatrix;
  }
  //顶点声明
