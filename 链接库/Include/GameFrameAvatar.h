...
public:
  ...
  //绘画头像
  VOID DrawUserAvatar(CDC * pDC, INT nXPos, INT nYPos, INT nWidth, INT nHeight, WORD wFaceID);
  //绘画头像
...
public:
  ...
  //绘画头像
  VOID DrawUserAvatar(CD3DDevice * pD3DDevice, INT nXPos, INT nYPos, INT nWidth, INT nHeight, WORD wFaceID);
  //绘画头像
...
public:
  //获取实例
  static CGameFrameAvatar * GetInstance()
  {
    return m_pGameFrameAvatar;
  }
};
