...
//数组定义
typedef CWHArray<tagGIFFrameInfo> CGIFFrameInfoArray;

//////////////////////////////////////////////////////////////////////////

//动画对象
class WH_IMAGE_CLASS CGIFImage
{
  //属性变量
protected:
...
public:
  ...
  WORD GetWidth()
  {
    return m_wImageWidth;
  }
  //图像高度
  WORD GetHeight()
  {
    return m_wImageHeight;
  }
  //当前图帧
  INT_PTR GetCurrentIndex()
  {
...
public:
  ...
  //图像数目
  INT_PTR GetFrameCount()
  {
    return m_GIFFrameInfoArray.GetCount();
  }
