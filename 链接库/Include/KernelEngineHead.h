...
//输出管理
interface ITraceServiceManager :
public IUnknownEx
{
  //状态管理
public:
...
//异步钩子
interface IAsynchronismEngineSink :
public IUnknownEx
{
  //启动事件
...
//数据库事件
interface IDataBaseEngineEvent :
public IUnknownEx
{
  //接口定义
public:
...
//网络事件
interface ITCPNetworkEngineEvent :
public IUnknownEx
{
  //接口定义
public:
