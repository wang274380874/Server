...
protected:
  ...
  //控制信息
protected:
  tagUserControlInfo        m_UserControlInfo;          //控制信息
...
public:
  ...
  {
    return m_lTrusteeScore;
  }
  //冻结积分
  virtual SCORE GetFrozenedScore()
  {
    return m_lFrozenedScore;
  }
...
public:
  ...
  {
    return m_bMobileUser;
  }
  //设置控制
  virtual VOID SetMobileUser(bool bMobileUser)
  {
    m_bMobileUser=bMobileUser;
  }
...
public:
  ...
  {
    return m_bAndroidUser;
  }
  //设置控制
  virtual VOID SetAndroidUser(bool bAndroidUser)
  {
...
public:
  ...
  {
    return m_dwSignUpTime;
  }
  //报名时间
  virtual VOID SetSignUpTime(DWORD dwSignUpTime)
  {
    m_dwSignUpTime=dwSignUpTime;
  }
  //报名状态
  virtual BYTE GetSignUpStatus()
  {
    return m_cbSignUpStatus;
  }
  //报名状态
...
public:
  //获取状态
  virtual BYTE GetUserControlStatus();
  //获取信息
  virtual tagUserControlInfo * GetUserControlInfo();
  //设置信息
  virtual VOID SetUserControlInfo(const tagUserControlInfo & UserControlInfo);
  //更新状态
  virtual VOID UpdateUserControlStatus(SCORE lJoinBlckWinScore,SCORE lJoinWhiteLoseScore);
...
public:
  ...
  {
    return m_wMobileUserRule;
  }
  //设置定义
  virtual VOID SetMobileUserRule(WORD wMobileUserRule)
  {
    m_wMobileUserRule=wMobileUserRule;
  }
  //当前分页
