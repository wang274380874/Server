...
//图像对象
class SKIN_CONTROL_CLASS CDataObject : public IDataObject
{
  //内核变量
protected:
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetDataHere(FORMATETC * pFormatEtc, STGMEDIUM *  pStgMedium)
  {
    return E_NOTIMPL;
  }
  ...
  virtual HRESULT STDMETHODCALLTYPE GetCanonicalFormatEtc(FORMATETC * pFormatEtcIn, FORMATETC * pFormatEtcOut)
  {
    return E_NOTIMPL;
  }
