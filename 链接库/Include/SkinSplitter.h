...
public:
  //获取类型
  enSplitterType GetSplitterType()
  {
    return m_SplitterType;
  }
  //获取接口
  ISplitterEvent * GetSplitterEvent()
  {
    return m_pISplitterEvent;
  };
  //设置范围
  VOID GetSplitterRange(INT & nMinDragPos, INT & nMaxDragPos)
  {
    nMinDragPos=m_nMinDragPos;
    nMaxDragPos=m_nMaxDragPos;
  }
